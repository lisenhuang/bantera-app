      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(user.displayName, style: Theme.of(context).textTheme.displayLarge?.copyWith(fontSize: 24)),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  ListTile(
                    leading: const Icon(Icons.language, color: BanteraTheme.primaryColor),
                    title: const Text('First Language'),
                    trailing: Text(user.firstLanguage, style: Theme.of(context).textTheme.bodyLarge),
                  ),
                  const Divider(),
                  ListTile(
                    leading: const Icon(Icons.school, color: BanteraTheme.primaryColor),
                    title: const Text('Learning'),
                    subtitle: Text('Current Level: ${user.level}'),
                    trailing: Text(user.learningLanguage, style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold)),
                  ),
                  const Divider(),
                  SwitchListTile(
                    ...
                    subtitle: const Text('Allow matching with complementary learners'),
